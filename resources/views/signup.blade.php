...
<body>
  <?php if (!empty($erro)): ?>
    <div class="bg-red-500 text-white p-4 rounded-lg mb-4">
      <p class="text-center">Erro ao cadastrar usuário. Tente novamente.</p>
    </div>
  <?php endif; ?>
        ...
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#ededed] px-10 py-3">
          ...
          <div class="flex flex-1 justify-end gap-8">
            ...
            <div
              ...
              <a class="truncate" href="/signinForm">Entrar</a>
            </div>
          </div>
        </header>
        <div class="px-40 flex flex-1 justify-center py-5">
          <div class="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5 max-w-[960px] flex-1">
            <h2 class="text-[#141414] tracking-light text-[28px] font-bold leading-tight px-4 text-center pb-3 pt-5">Cadastre-se para comentar</h2>
            <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
              <label class="flex flex-col min-w-40 flex-1">
                <p class="text-[#141414] text-base font-medium leading-normal pb-2">Nome</p>
                <input
                  name="nome"
